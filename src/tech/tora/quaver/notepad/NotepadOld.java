...
public class NotepadOld {
	...
	public NotepadOld(Configuration c) {
...
//		}
	...
	private void generateTestDataset() {
		// Get from 
//		Library sketch = new Library("/", "Default");
//		Library privLib = new Library("/", "Private");
//		Library pubLib = new Library("/", "Work");
//		
