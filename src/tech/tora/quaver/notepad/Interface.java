...
public class Interface extends JFrame {
	...
	public Interface() {
		if (initialiseNotebookAndNotes()) generateUI2();
		else Launcher.exit(1, "Failed");
	}
	...
	private void generateUI2() {

		QuickList qlist = new QuickList("Notebooks");
		qlist.addNode(new QuickListNode(qlist, "", "Java Notebook", "4"));
		qlist.addNode(new QuickListNode(qlist, "", "Linux Handbook", "0"));
		qlist.addNode(new QuickListNode(qlist, "", "Research Notes", "23"));
		
		SelectionList list1 = new SelectionList();
		list1.addNode(new SelectionListNode(list1, "Seeker", "10 Jan, 2016"));
		list1.addNode(new SelectionListNode(list1, "Spirit", "24 Mar, 2014"));
		list1.addNode(new SelectionListNode(list1, "Sage", "10 Jun, 2010"));
		list1.addNode(new SelectionListNode(list1, "True", "14 Jan, 2013"));

		JPanel l1Pane = new JPanel(new BorderLayout());
		l1Pane.setBackground(new Color(230, 230, 230));
		l1Pane.add(qlist, BorderLayout.CENTER);

		JLabel label = new JLabel("Notebooks | Tags");
		label.setFont(new Font("Helvetica", Font.BOLD, 14));
		label.setHorizontalAlignment(JLabel.CENTER);
		label.setPreferredSize(new Dimension(200, 30));
		
		JPanel l1TopPane = new JPanel(new BorderLayout());
		l1TopPane.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, new Color(140, 140, 140)));
		l1TopPane.setBackground(new Color(230, 230, 230));
		l1TopPane.add(label, BorderLayout.NORTH);
		l1Pane.add(l1TopPane, BorderLayout.NORTH);
		
		
		JPanel l1BotPane = new JPanel();
		l1Pane.add(l1BotPane, BorderLayout.SOUTH);
		
		JPanel l2Pane = new JPanel(new BorderLayout());
		l2Pane.setBackground(new Color(230, 230, 230));
		l2Pane.add(list1, BorderLayout.CENTER);

		JLabel label2 = new JLabel("Java Notebook");
		label2.setFont(new Font("Helvetica", Font.BOLD, 14));
		label2.setHorizontalAlignment(JLabel.CENTER);
		label2.setPreferredSize(new Dimension(300, 30));
		
		JPanel l2TopPane = new JPanel(new BorderLayout());
		l2TopPane.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, new Color(140, 140, 140)));
		l2TopPane.setBackground(new Color(230, 230, 230));
		l2TopPane.add(label2, BorderLayout.NORTH);
		l2Pane.add(l2TopPane, BorderLayout.NORTH);
		
		JPanel l2BotPane = new JPanel();
		l2BotPane.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, new Color(140, 140, 140)));
		l2Pane.add(l2BotPane, BorderLayout.SOUTH);
		
		JPanel leftPane = new JPanel(new BorderLayout());
		leftPane.add(l1Pane, BorderLayout.WEST);
		leftPane.add(l2Pane, BorderLayout.EAST);
		...
		JScrollPane editScroll = new JScrollPane(editArea, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		editScroll.setBorder(new InsetsBorder(new Insets(0, 0, 0, 0)));
		
		JEditorPane previewArea = new JEditorPane();
		DefaultCaret caret2 = (DefaultCaret)previewArea.getCaret();
		...
		rightPane.setBackground(new Color(140, 140, 140));
		rightPane.add(rightTopPane, BorderLayout.NORTH);
		rightPane.add(editScroll, BorderLayout.CENTER);
		
		JPanel wrapperPane = new JPanel(new BorderLayout());
		wrapperPane.setBackground(new Color(100, 100, 100));
		wrapperPane.add(leftPane, BorderLayout.WEST);
		wrapperPane.add(rightPane, BorderLayout.CENTER);
